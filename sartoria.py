...
from capi_principale import CapoPrincipale, Giacca, Pantalone, Gilet 
...
class Sartoria:
    ...
    def rimuovi_capo(self, codice): #scorro la lista e rimuovo il capo con il codice corrispondente usando una list comprehension
    ...
    def modifica_capo(self, codice, nuovo_prezzo=None, nuova_taglia=None): #funzione per modificare i capi in cui uso parametri opzionali con valore none per permettere alcune modifiche
    ...
    def aggiungi_componente(self, comp): #verifico che l'oggetto sia un'istanza di componentefinitura prima di aggiungerlo
        if isinstance(comp, ComponenteFinitura):
            self._componenti.append(comp)
